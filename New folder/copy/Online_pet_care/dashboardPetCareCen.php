...
session_start();
 $email=$_SESSION['email'];
  ...
  $query1="SELECT * FROM petcarecenter WHERE email='$email'";
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="">Doctors details</a>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href="">Treatments details</a>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href="">labroratary service</a>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href="">OPD service</a>
          </li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <h2>View Pets</h2>
            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
            <p><a class="btn btn-secondary" href=".\pet\petindex.php" role="button">View Pets &raquo;</a></p>
          </div>
          <div class="col-md-4">
            <h2>Pet Cemtery</h2>
            <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
            <p><a class="btn btn-secondary" href="petcemetry.php" role="button">View Cemetry &raquo;</a></p>
          </div>
        </div>
