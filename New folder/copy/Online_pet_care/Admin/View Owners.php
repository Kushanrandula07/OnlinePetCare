...
echo "<script>window.location.href = 'View Owners.php'</script>";     
} 
?>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h2><b>Pet Owners Management</b></h2>
                    </div>                      
                </div>
            </div>
                ...
                <!--Fetch the Records -->
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="View Owners.php?delid=<?php echo ($row['Id']);?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
