...
$selectSQL6 = "SELECT * FROM pets WHERE OwnerName='$Qusername'";
...
<head>
                  ...
                  <div class="panel-body">
                    ...
                    <form class="form" role="form" method="POST" accept-charset="UTF-8">
                      ...
                      <select name="selectpetname">
                        ...
                        ?>
                        <option id="<?php echo $pid=$row['PetID'];?>"><?php echo $row['PetName'];?></option>
                        <?php
                        }
                        ?>
  ...
  {
  $selectSQL5 = "SELECT * FROM doctorschedule inner join doctor on doctorschedule.Doc_id = doctor.Doc_id WHERE  doctorschedule.scheduleId='$Approval_id'";
            ...
            while ($row1= mysqli_fetch_array($r5)){
                ...
                $Status=$row1['Status'];
                      ...
                      $create_datetime = date("Y-m-d H:i:s");
                        ...
                        $newstatus='pending';
                        $query=mysqli_query($conn, "insert into appointment(Id,Doc_id,scheduleID,location,PetID,Petname,app_symptm,comment,status,timestamp) value('$Qid','$Doc_id', '$Approval_id', '$location', '$pid', '$selectpetname', '$symptom','$comment','$newstatus','$create_datetime' )");
