...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="petindex.php?moveid=<?php echo ($row['PetID']);?>&&ppic=<?php echo $row['ProfilePic'];?>" class="moveCem" title="moveCem" data-toggle="tooltip" onclick="return confirm('Do you wanna request Pet Cemetry ?');"><I class="material-icons">&#xE91D;</i></a>
