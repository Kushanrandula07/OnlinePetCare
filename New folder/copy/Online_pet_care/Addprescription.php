...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($conn, "insert into prescription(PetID,IssuedDate,app_ID,Image,Doc_id,OwnerID) value('$PetID','$create_datetime', '$app_ID','$imgnewfile', '$Doc_id', '$OwnerID')");
...
<div class="signup-form">
    ...
    <p class="hint-text">Add image.</p>
        ...
        <div>
        Pet Name
        <input type="text" class="form-control" name="PetName" id="PetName" value="<?php echo $QPetname; ?>" required="true"></div>
        ...
        Symptom
        <input type="text" class="form-control" name="app_symptm" id="app_symptm"  placeholder="symptm " value="<?php echo $Qapp_symptm;?>" required="true"></div>
