...
session_start();
 ...
 $Qemail=$_SESSION['email'];
  ...
  $nor1= mysqli_num_rows($r1);
    ...
    $selectSQL = "SELECT * FROM doctorschedule WHERE  Status='$Approvalstatus'";
...
<li class="nav-item dropdown">
                            ...
                            <?php  
                              ...
                              ?>
                                 <tr>
                                      ...
                                      <td><a name="booking" href="booking.php?Service_approve=<?php echo $Service_approve=$row['scheduleId']?>" class="btn btn-primary">Request Booking</a></td>
                                  </tr>
                              <?php
                              }
                              ?>
    ...
    $date2 = "2021-01-18";
      ...
      if ($today < $date2) {
        echo "$today is earlier than $date2";
      } else {
        echo "$today is later than $date2";
      }
    }
