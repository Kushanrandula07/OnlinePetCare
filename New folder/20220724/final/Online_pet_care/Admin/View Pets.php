...
echo "<script>window.location.href = 'View Pets.php'</script>";     
} 
?>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                        $ret=mysqli_query($conn,"select * from pets");
                        $cnt=1;
                ...
                <!--Fetch the Records -->
                    <tr>
                        <td><?php echo $cnt;?></td>
                        <td><img src="../pet/profilepics/<?php  echo $row['ProfilePic'];?>" width="80" height="80"></td>
                        ...
                        <td>
                            ...
                            <a href="View Pets.php?delid=<?php echo ($row['PetID']);?>&&ppic=<?php echo $row['ProfilePic'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
