...
$sql=mysqli_query($conn,"delete from petshop where shop_id=$rid");
//unlink($ppicpath);
echo "<script>alert('Data deleted');</script>"; 
echo "<script>window.location.href = 'View Pet shop.php.php'</script>";     
} 
?>
...
<head>
    <meta charset="utf-8">
    <title>View all pet shops</title>
    <meta charset="utf-8">
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                        $ret=mysqli_query($conn,"select * from petshops");
                        $cnt=1;
                ...
                <!--Fetch the Records -->
                    <tr>
                        ...
                        <td>
                            <a href="View Pet shop.php?delid=<?php echo ($row['PetshopID']);?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
