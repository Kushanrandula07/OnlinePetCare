...
$selectSQL = "SELECT * FROM doctorschedule INNER JOIN appointment ON doctorschedule.scheduleId = appointment.scheduleID WHERE doctorschedule.Doc_name='$username' AND doctorschedule.Status='$Approvalstatus'";
