...
$sql=mysqli_query($conn,"delete from petcarecenter where pet_care_center_id=$rid");
//unlink($ppicpath);
echo "<script>alert('Data deleted');</script>"; 
echo "<script>window.location.href = 'View Pet Care Center.php'</script>";     
} 
?>
...
<head>
    <meta charset="utf-8">
    <title>View all pet Care Centers</title>
    <meta charset="utf-8">
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                        $ret=mysqli_query($conn,"select * from petcarecenter");
                        $cnt=1;
                ...
                <!--Fetch the Records -->
                    <tr>
                        <td><?php echo $cnt;?></td>
                        <td><?php  echo $row['pet_care_center_name'];?> </td>
                        ...
                        <td>
                            <a href="View Pet Care Center.php?delid=<?php echo ($row['PCC_id']);?>&" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
