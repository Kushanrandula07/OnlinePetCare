    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                        $ret=mysqli_query($conn,"select * from pets where OwnerName='$Qusername'");
...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Addpetcemetry.php?moveid=<?php echo ($row['PetID']);?>&&ppic=<?php echo $row['ProfilePic'];?>" class="moveCem" title="moveCem" data-toggle="tooltip" onclick="return confirm('Do you wanna request Pet Cemetry ?');"><I class="material-icons">&#xE91D;</i></a>
