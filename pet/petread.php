      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="../dashboard.php.php">Home <span class="sr-only">(current)</span></a>
          </li>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <a href="../Viewprescription.php?View_id=<?php echo htmlentities ($row['PetID']);?>"  class="btn btn-secondary"><I class="material-icons">&#xE91D;</i> <span>View prescription</span></a>
